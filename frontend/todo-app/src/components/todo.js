        ...
        <div>
            ...
            <form style={{paddingTop: '40px'}} className={classes.root}  onSubmit={handleSubmit(onSubmit)}>
                <TextField 
                    ...
                    /> <br/>
                {errors.task && <div style={{display:'inline'}}><p>Task name should have <br/> 2 to 20 characters</p><br/></div>}
                <TextField
                    name="description"
                    ...
                    inputRef={register({ required: true , minLength: 0, maxLength: 200})}
                /> <br/>
                {errors.task && <div style={{display:'inline'}}><p>Task description should have <br/> max 200 characters</p><br/></div>}
                <TextField 
                    name="targetDate"
                    label="Due Date" 
                    variant="outlined" 
